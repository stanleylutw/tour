...
18. 使用者第一次輸入 passcode 登入成功時，預設顯示「所有旅程」主選單；已登入狀態重新開啟或重新整理 app 時，才沿用固定旅程 / 最近旅程自動開啟邏輯。
19. 使用者提供 DOCX、PDF、截圖或其他旅程附件時，Codex 必須深度掃描並萃取可放入 HTML 的重點：日期、航班、每日活動、餐食、住宿候選、費用、訂金、簽證 / 稅金、旅行社聯絡資訊、入境提醒、行李與小費提醒等。
